			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						...
						<li class="fmobile"><?php echo $ayarcek['ayar_tel']  ?><br><?php echo $ayarcek['ayar_fax']  ?></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author']  ?><a href="#"><?php echo $ayarcek['ayar_smtphost']?></a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_instagram'];  ?>" class="finstagram">İnstagram</a>
